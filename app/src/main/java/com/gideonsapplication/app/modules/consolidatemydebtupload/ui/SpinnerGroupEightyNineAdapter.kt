...
class SpinnerGroupEightyNineAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupEightyNineModel>
) : ArrayAdapter<SpinnerGroupEightyNineModel>(mContext, layoutResource, allItems) {
