...
class SpinnerGroupEightyFiveAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupEightyFiveModel>
) : ArrayAdapter<SpinnerGroupEightyFiveModel>(mContext, layoutResource, allItems) {
