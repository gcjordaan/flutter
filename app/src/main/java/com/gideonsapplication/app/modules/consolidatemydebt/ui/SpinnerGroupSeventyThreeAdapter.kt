...
class SpinnerGroupSeventyThreeAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupSeventyThreeModel>
) : ArrayAdapter<SpinnerGroupSeventyThreeModel>(mContext, layoutResource, allItems) {
