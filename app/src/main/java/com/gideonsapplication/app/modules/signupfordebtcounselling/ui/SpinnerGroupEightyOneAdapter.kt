...
class SpinnerGroupEightyOneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupEightyOneModel>
) : ArrayAdapter<SpinnerGroupEightyOneModel>(mContext, layoutResource, allItems) {
