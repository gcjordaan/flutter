...
class SpinnerGroupEightySevenAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupEightySevenModel>
) : ArrayAdapter<SpinnerGroupEightySevenModel>(mContext, layoutResource, allItems) {
