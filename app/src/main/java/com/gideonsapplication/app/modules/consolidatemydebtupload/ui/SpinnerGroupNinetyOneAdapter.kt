...
class SpinnerGroupNinetyOneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupNinetyOneModel>
) : ArrayAdapter<SpinnerGroupNinetyOneModel>(mContext, layoutResource, allItems) {
