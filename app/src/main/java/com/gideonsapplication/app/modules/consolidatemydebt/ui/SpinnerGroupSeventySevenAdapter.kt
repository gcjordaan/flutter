...
class SpinnerGroupSeventySevenAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupSeventySevenModel>
) : ArrayAdapter<SpinnerGroupSeventySevenModel>(mContext, layoutResource, allItems) {
